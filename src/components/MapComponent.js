...
export default class MapComponent extends Component {
  ...
  componentDidUpdate(){
    ...
    render () {
      ...
      return (
        <View>
            <MapView provider={PROVIDER_GOOGLE} style={styles.map} customMapStyle={mapStyle} ref = {this._map}>
            {this.props.userOrigin.latitude != null && 
              <Marker coordinate = {this.props.userOrigin} anchor = {{x:0.5,y:0.5}}>
                  <Image source={require('../../assets/images/carMarker.png')} style={{ 
                    height: 28,
                    width: 50
                  }} />
              </Marker>
            ...
            { this.props.userDestination.latitude != null &&   
              <Marker coordinate = {this.props.userDestination} anchor = {{x:0.5,y:0.5}} title={this.props.userOrigin.name} description={this.props.userOrigin.description}>
                 <Image source={require('../../assets/images/carMarker.png')} style={{ 
                    height: 28,
                    width: 50
                  }} />
