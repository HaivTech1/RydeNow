import { View, Text, TouchableOpacity, StyleSheet, Dimensions, Button, Image } from 'react-native'
import React, { useCallback, useContext, useEffect, useMemo, useRef, useState } from 'react'
import { ChevronDownIcon, ChevronLeftIcon, ClockIcon, ForwardIcon, StarIcon } from 'react-native-heroicons/outline'
      ...
      <View>
        ...
        >
            <View style={styles.container}>
                ...
                <Text className="text-center font-extrabold text-xl">Please wait...</Text>
                <Text className="text-center text-lg font-normal">Connecting your driver</Text>
                <Text className="text-center text-[15px] px-5 my-2">The driver will be on their way as soon as they confirm</Text>

                <View className="">
                    <View className="flex-row items-center space-x-20 py-2 mx-auto">
                        ...
                        <TouchableOpacity onPress={() => setVisible(true)} className="flex-col justify-center items-center">
                            <View className="bg-[#FF6600]/20 rounded-full p-3 text-center">
                                <Image source={require('../../assets/images/cars/cancel.png')} className="w-[30px] h-[30px]" />
                            </View>
                            <Text className="text-lg font-thin mt-1">Cancel ride</Text>
                        </TouchableOpacity>
                    </View>
                ...
                <View className="mt-5 mx-1 flex-row justify-around items-center">
